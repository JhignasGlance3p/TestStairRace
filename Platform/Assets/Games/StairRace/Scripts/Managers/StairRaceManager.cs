...
namespace nostra.pkpl.stairrace
{
    public class StairRaceManager : MonoBehaviour
    {
        ...
        public void OnLoaded()
        {
            ...
            StateRegistry.Register<SRPowerData>();
        ...
        public void RegisterPowerup(PowerupController _powerup)
        {
            replayMapper.Add(_powerup.id, _powerup);
            m_handler.RegisterTrackable(_powerup);
            m_handler.SetReplayMapper(replayMapper);
        }
    ...
    [Serializable]
    public class SRPowerData : IGameObjectState
    {
        public string Id;
        public bool canCapture;
